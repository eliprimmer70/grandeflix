-- Incremental migration: Coming Soon + reminders (safe if base schema already applied)
-- Run in Supabase SQL Editor if you see: "Could not find the 'coming_soon' column of 'content'"
